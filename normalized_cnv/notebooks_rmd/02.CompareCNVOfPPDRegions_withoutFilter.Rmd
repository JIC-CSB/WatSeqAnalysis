...
The input includes ```6,665,337```  out of  ````6,719,174```. The excluded regions have no coverage across any of the lines. 
Cov: 6719174
...
libsd <- read.csv("~/Documents/WatSeq/Deletions/20200702/200bp/libSD_short.csv")
...
lines2 <- c("WATDE0027", "WATDE0164", "WATDE0165", "WATDE0141", "WATDE0018")
...
p2 <- plotLibraryOnChromosomeInterval(cov_ppda1, lines=lines2, title = "Original coverage", col="cov" ) + coord_cartesian(ylim=c(0,50) )
...
#tbl <- cov_tb1[cov_tb1$chromStart > 18470237 & cov_tb1$chromEnd < 18470638,]
#tbl <- norm_cov_tb1[norm_cov_tb1$cov == 0 & norm_cov_tb1$chromStart == 18470438,]
tbl <- cov_tb1[cov_tb1$cov == 0 & cov_tb1$chromStart == 18470438,]
kable(tbl)
#plotHistogram(tbl, column="cov", trim_range=T,  filter_zero=FALSE) 
``` 
