...
* WatSeq
 * Simon Griffiths (JIC), Cheng Shifeng (AGIS),  Burkhard Stauernagel (JIC)
* Paragon 𝛾-radiation lines 
 * Paul Nichleson (JIC), Ben Hales (JIC), Anil Thanki (EI), Matt Clark (EI/NHM)

![](images/UauyLab2020){ height=50% }